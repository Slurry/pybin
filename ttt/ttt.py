...
# how AI gets an available sequence to win get_unblocked_sequence. 
# returns a wcombo, and marker
...
>>> board = pl_sequence(seq, mrk) # <- for testing
>>> 'x' in board[0:9]
True

>>> # only one available sequence left at 3,4,5
...
>>> board = ['o', 'o', 'o', '3', '4', '5', 'x', 'o', 'x']
>>> winner_check(wcombos, board)
('o', [0, 1, 2])
